...
def build_llm_prompt(error_text):
    ...
    return f"""Act as a terminal expert!

Error: {error_text}

Provide a 1-sentence fix. 
If it's a missing library, provide the 'pip install' or 'npm install' command.
If it's a syntax error, show the corrected line.
NO INTROS. NO CHAT. ONLY THE FIX.
"""
